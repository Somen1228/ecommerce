                ...
                {cartData.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <input onClick={(e) => updateQuantity(productData._id, item.size, e.target.value)} className="border max-w-10 sm:max-w-20 px-1 sm:px-2 py-1" type="number" min={1} defaultValue={item.quantity}/>
