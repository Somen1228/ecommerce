...
const Collection = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t cursor-pointer">
            {/* Filter Options */}
                    ...
                    <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
                        <p className="flex gap-2">
                            <input
                                ...
                                value={"Men"}
                            />{" "}
                            <label className='cursor-pointer' htmlFor="men">Men</label>
                        </p>
                        <p className="flex gap-2">
                            <input
                                id="women"
                    ...
                    <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
                        <p className="flex gap-2">
                            <input
                                ...
                                value={"Topwear"}
                            />{" "}
                            <label className='cursor-pointer' htmlFor="top-wear">Topwear</label>
                        </p>
                        <p className="flex gap-2 cursor-pointer">
                            <input
                                ...
                                value={"Bottomwear"}
                            />{" "}
                            <label className='cursor-pointer' htmlFor="bottom-wear">Bottomwear</label>
                        ...
                        <p className="flex gap-2">
                            <input
                                ...
                                value={"Winterwear"}
                            />{" "}
                            <label className='cursor-pointer' htmlFor="winter-wear">Winterwear</label>
                        </p>
                    </div>
                </div>
            </div>
